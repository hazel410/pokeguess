...
PHYSICS_AIR_RESISTANCE = .001   # very small non-negative values
PHYSICS_IS_TIMER_BASED = True
PHYSICS_MAX_COLLISIONS = [7, 10]
PHYSICS_TICK_TIMER = [400, 600]
PHYSICS_TIMER_DESPAWN_WHEN = 30
PHYSICS_TIMER_FLASH_LENGTH = 2
